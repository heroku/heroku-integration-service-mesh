...
echo "Release $release_tag created on commit $sha and pushed successfully. Check https://github.com/heroku/heroku-applink-service-mesh/actions/workflows/release.yml for GH Action status."
